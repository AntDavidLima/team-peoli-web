...
function Exercise() {
              ...
              <Form {...form}>
                ...
                >
                      ...
                      <FormItem>
                        ...
                        {form.getValues("executionVideoUrl") && (
                          <div className="flex justify-center">
                            <video
                              className="h-48 aspect-video bg-card rounded"
                              controls
                            >
                              <source
                                src={
                        ...
                        {(creatingExercise || updatingExercise) && value && (
                          <Progress
                            value={videoUploadProgress.value}
                            className="h-2"
                          />
                        )}
                        <FormMessage />
                    ...
                    render={({ field: { value, onChange, ...field } }) => (
                      <FormItem>
                        ...
                        {form.getValues("thumbnailUrl") && (
                          <div className="flex justify-center bg-card rounded">
                            <img
                              src={form.getValues("thumbnailUrl") || undefined}
                              className="h-48 aspect-[9/16]"
                            />
                          </div>
                        )}
                        <div className="flex gap-2">
                        ...
                        <FormMessage />
                        <FormDescription>
                          Imagem que será exibida como thumbnail do vídeo
                        </FormDescription>
                      </FormItem>
                    )}
                  />
                  ...
                  <Button disabled={creatingExercise || updatingExercise}>
                    {(creatingExercise || updatingExercise) && (
  ...
  async function updateExercise({
    ...
    await api.patchForm(
      `/exercise/${edittingExerciseId.value}`,
      {
        name,
        restTime,
        instructions: JSON.stringify(instructionsRawDraft),
